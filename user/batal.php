    ...
    <div class="container">
        ...
        <div class="cart-product">
            <div class="cart-title">
                <p style="margin: 0 20px; text-align: center; cursor: pointer;" class="active">my order-cancel</p>
...
?></mark></td>
                                    ...
                                    <td><a style="color: rgb(114, 114, 114)" class="text-white" href="proses.php?kc_id=<?php echo $row['id_checkout'] ?>" onclick="return confirm('Yakin proudk telah sampai?')">
